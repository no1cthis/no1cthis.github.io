  ...
  return (
    <section className={cl.wrapper}>
      ...
      {/* <div className={cl.project}>
        <div className={cl.name}>Code editor</div>
        <div className={cl.preview}>
          <div className={cl.info}>
            <a
              href="https://github.com/no1cthis/code-editor"
              className={cl.github}
            >
              Github
            ...
            <a
              href="https://no1cthis.github.io/code-editor/"
              className={cl.eye__wrapper}
            >
          ...
          <img className={cl.project__image} src={project1} alt="test img" />
        </div>
      </div> */}
      <Project
        name="Code editor"
